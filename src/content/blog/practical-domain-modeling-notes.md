...
categories:
- engineering
image: images/blog-covers/practical-domain-modeling-notes.jpg
---

こんにちは。最近昇格をして、会社から評価されることって意外と気持ちいいだなと実感しました。たまたまBookoffで実践ドメインモデリングを見つけたので書いました。3500円とお高めだったけど完全に理解したらコスパ良すぎと思い書いたのですが、今の時代PDF化してLLM経由で摂取した方が脳に優しいのかとあとで後悔した（後で後悔は頭痛が痛い）のは思い出として残しておきます。
